        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-primary-foreground">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-display font-bold">Admin Portal</span>
            </div>
            ...
            <div className="mt-12 space-y-4">
              <div className="flex items-center gap-3 text-primary-foreground/70">
                ...
                <span>Full schedule management</span>
              </div>
              <div className="flex items-center gap-3 text-primary-foreground/70">
                <div className="w-2 h-2 rounded-full bg-primary-foreground" />
                <span>Approval workflow control</span>
              </div>
              <div className="flex items-center gap-3 text-primary-foreground/70">
                <div className="w-2 h-2 rounded-full bg-primary-foreground" />
        ...
        >
          ...
          <div className="p-4 mb-6 rounded-lg bg-secondary/50 border border-border">
            ...
            <p className="text-sm text-foreground">
              <span className="font-medium">Email:</span> {MOCK_ADMIN_CREDENTIALS.email}
            </p>
            <p className="text-sm text-foreground">
              <span className="font-medium">Password:</span> {MOCK_ADMIN_CREDENTIALS.password}
            </p>
          </div>
