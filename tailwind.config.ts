  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'inner-gold': 'var(--shadow-inner-gold)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gold-gradient': 'linear-gradient(135deg, hsl(var(--year-1)) 0%, hsl(var(--primary)) 50%, hsl(var(--year-5)) 100%)',
        'premium-gradient': 'linear-gradient(135deg, hsl(var(--primary) / 0.1) 0%, transparent 50%, hsl(var(--primary) / 0.05) 100%)',
        'card-gradient': 'linear-gradient(180deg, hsl(var(--card)) 0%, hsl(var(--background)) 100%)',
        'hero-pattern': 'radial-gradient(ellipse 80% 50% at 50% -20%, hsl(var(--primary) / 0.15) 0%, transparent 70%)',
      },
      keyframes: {
        "accordion-down": {
